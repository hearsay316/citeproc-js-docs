...
var SafeStorage = function () {
    function SafeStorage(citesupport) {
    ...
    _createClass(SafeStorage, [{
        key: '_safeStorageGet',
        value: function _safeStorageGet(key, fallback) {
            var ret;
        ...
        key: 'citationByIndex',
        set: function set(citationByIndex) {
        ...
        key: 'citationIdToPos',
        set: function set(citationIdToPos) {
...
var CiteSupport = function () {
    function CiteSupport() {
        _classCallCheck(this, CiteSupport);
        ...
        this.worker.onmessage = function (e) {
            switch (e.data.command) {
                ...
                case 'initProcessor':
                    ...
                    console.log(me.config.mode, citationData,'me.config.mode, citationData');
    ...
    _createClass(CiteSupport, [{
        ...
        key: 'callInitProcessor',
        value: function callInitProcessor(styleName, localeName, citationByIndex) {
        ...
        key: 'callRegisterCitation',
        value: function callRegisterCitation(citation, preCitations, postCitations) {
        ...
        key: 'convertRebuildDataToCitationData',
        value: function convertRebuildDataToCitationData(rebuildData) {
        ...
        key: 'setCitations',
        value: function setCitations(mode, data) {
        ...
        key: 'setBibliography',
        value: function setBibliography(data) {
        ...
        key: 'citationWidgetHandler',
        value: function citationWidgetHandler(e) {
        ...
        key: 'citationWidget',
        value: function citationWidget(citationNode) {
        ...
        key: 'citationEditHandler',
        value: function citationEditHandler(e) {
        ...
        key: 'getCitationSplits',
        value: function getCitationSplits(nodes) {
        ...
        key: 'getCitationItemIdsFrom',
        value: function getCitationItemIdsFrom(menu) {
        ...
        key: 'setStyleListener',
        value: function setStyleListener() {
        ...
        key: 'hasRoomForMenu',
        value: function hasRoomForMenu(obj) {
            var curleft = 0,
                curtop = 0;
            if (obj.offsetParent) {
                do {
